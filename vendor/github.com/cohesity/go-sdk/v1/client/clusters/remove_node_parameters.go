...
// WithID adds the id to the remove node params
func (o *RemoveNodeParams) WithID(id int64) *RemoveNodeParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the remove node params
func (o *RemoveNodeParams) SetID(id int64) {
	o.ID = id
}
