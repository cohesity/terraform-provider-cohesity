...
// WithPreferences adds the preferences to the update user preferences params
func (o *UpdateUserPreferencesParams) WithPreferences(preferences map[string]string) *UpdateUserPreferencesParams {
	o.SetPreferences(preferences)
	return o
}

// SetPreferences adds the preferences to the update user preferences params
func (o *UpdateUserPreferencesParams) SetPreferences(preferences map[string]string) {
