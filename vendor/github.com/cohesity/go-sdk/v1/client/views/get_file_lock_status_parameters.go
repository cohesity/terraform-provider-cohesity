...
// WithName adds the name to the get file lock status params
func (o *GetFileLockStatusParams) WithName(name string) *GetFileLockStatusParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the get file lock status params
func (o *GetFileLockStatusParams) SetName(name string) {
	o.Name = name
}
