...
// WithSid adds the sid to the rotate user Api key params
func (o *RotateUserAPIKeyParams) WithSid(sid string) *RotateUserAPIKeyParams {
	o.SetSid(sid)
	return o
}

// SetSid adds the sid to the rotate user Api key params
func (o *RotateUserAPIKeyParams) SetSid(sid string) {
	o.Sid = sid
}
