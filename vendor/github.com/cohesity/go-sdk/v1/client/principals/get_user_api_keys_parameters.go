...
type GetUserAPIKeysParams struct {
	...
	/* Ids.
	   ...
	   Specifies a list of API key ids.
	*/
	Ids []string
...
// WithSid adds the sid to the get user Api keys params
func (o *GetUserAPIKeysParams) WithSid(sid string) *GetUserAPIKeysParams {
	o.SetSid(sid)
	return o
}

// SetSid adds the sid to the get user Api keys params
func (o *GetUserAPIKeysParams) SetSid(sid string) {
	o.Sid = sid
}
