...
// WithCount adds the count to the get notifications params
func (o *GetNotificationsParams) WithCount(count int64) *GetNotificationsParams {
	o.SetCount(count)
	return o
}

// SetCount adds the count to the get notifications params
func (o *GetNotificationsParams) SetCount(count int64) {
	o.Count = count
}
...
func (o *GetNotificationsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if err := r.SetBodyParam(o.Count); err != nil {
		return err
	}
