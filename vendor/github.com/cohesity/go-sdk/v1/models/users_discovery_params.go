...
// UsersDiscoveryParams Source Discovery parameters for kUser entity type.
//
...
type UsersDiscoveryParams struct {
	...
	// Specifies whether users' chats should be backed up or not. If this is
	// false or not specified users' chats backup will not be done.
	AllowChatsBackup *bool `json:"allowChatsBackup,omitempty"`

	// Specifies if office 365 users with valid mailboxes should be discovered or
	// not.
	DiscoverUsersWithMailbox *bool `json:"discoverUsersWithMailbox,omitempty"`

	// Specifies if office 365 users with valid Onedrives should be discovered or
	// not.
