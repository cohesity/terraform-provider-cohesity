...
type DataUsageStats struct {
	...
	// Specifies the storage used before any data reduction
	...
	// Specifies the data written after it has been reduced by deduplication and
	// compression at a previous time. This does not include resiliency impact.
	...
	// Specifies the size of the data has been replicated to other nodes as per
	// RF or Erasure Coding policy at a specific time.
	...
	// Specifies the total capacity, as computed by the Cohesity Cluster,
	// after the size of the data has been reduced by change-block tracking,
	// compression and deduplication at a previous time to compare. This
	// includes resiliency impact.
