...
// CreateIdpConfigurationRequest Create IdP Configuration Request.
//
// Specifies the configuration for an IdP service to be created.
//
// swagger:model CreateIdpConfigurationRequest
...
// Validate validates this create idp configuration request
func (m *CreateIdpConfigurationRequest) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this create idp configuration request based on context it is used
func (m *CreateIdpConfigurationRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CreateIdpConfigurationRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateIdpConfigurationRequest) UnmarshalBinary(b []byte) error {
	var res CreateIdpConfigurationRequest
