...
// WithDefaults hydrates default values in the get racks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRacksParams) WithDefaults() *GetRacksParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get racks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRacksParams) SetDefaults() {
