...
type CreateBondParams struct {
	...
	/* Body.
	   ...
	   Parameters to create bond.
	*/
	Body *models.CreateBondParams
...
func (o *CreateBondParams) WithBody(body *models.CreateBondParams) *CreateBondParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create bond params
func (o *CreateBondParams) SetBody(body *models.CreateBondParams) {
	o.Body = body
}
