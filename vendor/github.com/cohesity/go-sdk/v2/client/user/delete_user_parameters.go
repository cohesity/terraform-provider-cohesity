...
// WithSid adds the sid to the delete user params
func (o *DeleteUserParams) WithSid(sid string) *DeleteUserParams {
	o.SetSid(sid)
	return o
}

// SetSid adds the sid to the delete user params
func (o *DeleteUserParams) SetSid(sid string) {
	o.Sid = sid
}
